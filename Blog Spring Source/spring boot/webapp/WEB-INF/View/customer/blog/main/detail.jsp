				...
				<tag:if test="${x.ref_comment == 0}">
					<li id="comment_area${x.id}">
					    ...
					    <p id="edit${x.id}">
							<tag:if test="${ x.user_name !='NULL' }">
								...
								<a onclick="DelComment(${board.num},${x.id})">삭제</a>
							</tag:if>
						</p>
					</li>
				    ...
				    <tag:forEach var="y" items="${recomment}" varStatus="status">
						<tag:if test="${y.ref_comment == x.id}">
							<li id="comment_area${y.id}" class="recomment"><i class="icon-terminal"></i>
								<p>
								...
								<p id="edit${y.id}">
									<tag:if test="${ y.user_name !='NULL' }">
										...
										<a onclick="DelComment(${board.num},${y.id})">삭제</a>
									</tag:if>
								</p></li>
