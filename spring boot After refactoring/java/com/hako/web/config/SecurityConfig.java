...
//            .antMatchers("/admin/**").authenticated()
                ...
                .antMatchers(HttpMethod.POST,"/admin/board").hasRole("ADMIN") 
                .antMatchers(HttpMethod.PUT,"/admin/board").hasRole("ADMIN") 
                .antMatchers(HttpMethod.DELETE,"/admin/board").hasRole("ADMIN") 
